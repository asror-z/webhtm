...
//
?>
<!--        <div class="row" style="margin-left:-8px; #125188;position: sticky;left:10px;top:0">-->
<!--               <div class="col-md-7 col-lg-7  col-sm-12 d-inline-block p-2 ">-->
<!--                   <p class="text-white m-0" >-->
<!--                       © 2020 Фонд Эл-юрт умиди при Агентстве развития государственной службы при-->
<!--                       Президенте Республики Узбекистан-->
<!--                   </p>-->
<!--               </div>-->
<!--               <div class="col-md-2 col-lg-3 col-sm-8 d-inline-block ">-->
<!--                   <div class="footer-ul d-flex pt-1">-->
<!--                       <div class="footer-li "><a class="footer-a" href="/ru/cores/main/index.aspx">Русский</a>-->
<!--                       </div>-->
...
<!---->
<!--        </div>-->
<!--               <div class="col-md-3 col-lg-2 col-sm-8 d-inline-flex counter-main">-->
<!--                --><?//
//                    if (!$boot->userDev())
